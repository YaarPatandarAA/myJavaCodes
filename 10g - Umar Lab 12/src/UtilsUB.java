    ...
    public static double readDouble(String prompt, boolean guiMode) {
        ...
        if(guiMode == false){
        	...
        	while (failed == true) {
        		// try catch needed for JOptionPane error inputs
        		try {
	        			// prompt for an input double value in J Option Pane
	        			String temp = JOptionPane.showInputDialog(prompt);
			        	data = Double.parseDouble(temp); // parse the string into a double
			        	failed = false;
		        	}
        		catch(NumberFormatException nfe) {
                    // intercepts a failed attempt to convert to an int
...
//----------------------------------------------------------------------------------------------------
    ...
    public static String readString(String prompt, boolean guiMode) {
        ...
        // set up data and objects
        Scanner input = new Scanner(System.in);
        String data = null; // Default empty for string
        
        if(guiMode == false){
	        // prompt for an input string value
	        System.out.print(prompt);
	        data = input.nextLine(); //read in string
        }
        else if(guiMode == true){
...
//-----------------------------------------------------------------------------------------------------    
    ...
    public static int randomInt(int minValue, int maxValue) {
        ...
        // setup new random datatype
        Random rand = new Random();

        // initialize random data type, with recived max min values
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
 ...
 //=====================================================================================================================================================================================================   
    ...
    public static void pause(String message){
    	// ignores any returned vaule
    	readString(message, false);
    	System.out.println(); // add a break line
    }
